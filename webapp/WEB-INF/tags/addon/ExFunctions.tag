...
public static Map<String, List<Object>> groupSearchResultsByDays(HttpServletRequest request, PageContext pageContext) {
...
public static List<CmsJspContentAccessBean> getNeighborsByParentFolder(CmsObject cms, CmsResource res, boolean readTree) {
    List<CmsJspContentAccessBean> result = new ArrayList<>(2);
    result.add(null);
    result.add(null);
    try {
...
public static CmsJspContentAccessBean foundPrevOrNextInNeighbors(CmsJspContentAccessBean res, List<CmsJspContentAccessBean> list, boolean backward) {
    for (int i = 0; i < list.size(); i++) {
...
public static String join(String sep, Collection<?> items) {
    return joinArray(sep, items.toArray(new Object[items.size()]));
}

public static String joinLines(Collection<?> items) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public static final Object debug(HttpServletRequest request, PageContext pageContext) {
    return null;
}
...
public static void log(Object... args) {
    ...
    final String logBody = concat(args);
    System.out.println(concat("LOG-", logTime, ": ", logBody));
    LOG.warn(logBody);
}%>